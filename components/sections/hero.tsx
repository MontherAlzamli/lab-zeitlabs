...
export function Hero({ className }: HeroProps) {
  return (
    <section
      className={cn(
        "relative w-full h-screen -mt-16 flex items-center overflow-hidden",
        className,
      )}
    >
      ...
      <div className="container mx-auto px-10 h-full flex items-center">
        {/* Left — text content */}
        <div className="flex flex-col gap-4 w-full relative z-200 md:w-[52%] pt-20 shrink-0">
          {/* Pill label */}
          <span className="inline-flex flex-none flex-row flex-nowrap items-center content-center justify-center gap-2 self-start h-min w-[50%] rounded-[40px] px-0.5 py-1.5 mb-2 relative z-[2] text-foreground text-body-sm font-medium will-change-transform">
          ...
          {/* Heading */}
          <h1 className="font-display text-h1 text-foreground animate-blur-in" style={{ animationDelay: "0.5s" }}>
            Experiment, Learn, Innovate
          </h1>

          {/* Body */}
          <p className="text-body text-[#333333] w-[98%]">
        ...
        <div className="flex-1 h-full relative z-10 flex items-center justify-center">
